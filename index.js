(function () {
    ...
    <div class="toolbar" style="position:fixed;top:0;left:0;right:0;padding:8px;background:#36393f;box-shadow: 0 1px 0 rgba(0,0,0,.2), 0 1.5px 0 rgba(0,0,0,.05), 0 2px 0 rgba(0,0,0,.05);">
        <div style="display:flex;flex-wrap:wrap;">
            <span>Authorization <a href="https://cdn.discordapp.com/attachments/664927615034982410/747978868677279810/unknown.png" title="Help">?</a> <button id="getToken">auto</button><br>
                <input type="password" id="authToken" placeholder="Auth Token" autofocus>*<br>
                <span>Author <a href="https://cdn.discordapp.com/attachments/664927615034982410/747978709939650601/unknown.png" title="Help">?</a> <button id="getAuthor">auto</button></span>
                <br><input id="authorId" type="text" placeholder="Author ID" priv></span>
            <span>Guild/Channel <a href="https://cdn.discordapp.com/attachments/664927615034982410/747978459766063244/unknown.png" title="Help">?</a>
            ...
            <span>Range <a href="https://cdn.discordapp.com/attachments/664927615034982410/747978194694439033/64141154-6ce62780-cddd-11e9-8b73-5fa54b866e46.png" title="Help">?</a><br>
            ...
            <span>Search messages <a href="https://cdn.discordapp.com/attachments/664927615034982410/747979555368599572/unknown.png" title="Help">?</a><br>
    ...
    <pre style="margin-top:200px;font-size:0.75rem;font-family:Consolas,Liberation Mono,Menlo,Courier,monospace;">
        <center>Star this project on <a href="https://github.com/Hastez/Discord-Message-Purger" target="_blank">github.com/Hastez/Discord-Message-Purger</a>!\n\n
            <a href="https://github.com/Hastez/Discord-Message-Purger/issues" target="_blank">Issues or help</a></center>
        </pre></body></html>`);
     ...
     * @author Hastez <https://www.github.com/Hastez>
     * @see https://github.com/Hastez/Discord-Message-Purger
     */
